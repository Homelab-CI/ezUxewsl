...
![Version: 9.1.7](https://img.shields.io/badge/Version-9.1.7-informational?style=flat-square) ![AppVersion: 2.0.1](https://img.shields.io/badge/AppVersion-2.0.1-informational?style=flat-square)
...
helm repo update
helm install paperless homelab-ci/paperless
```
...
helm install paperless \
  --set env.TZ="America/New York" \
    homelab-ci/paperless
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install paperless homelab-ci/paperless -f values.yaml
```
